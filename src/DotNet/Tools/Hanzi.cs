...
namespace DotNet.Tool
{
    ...
    public class Hanzi
    {
        ...
        public static string ToPinyin(string hanzi, int maxLength=10)
        {
            ...
            if (maxLength <= 1)
                maxLength = 10;
            hanzi = hanzi.Trim().Replace(" ", "").Replace("?", "_").Replace("\\", "_").Replace("/", "_").Replace(":", "").Replace("*", "").Replace(">", "").Replace("<", "").Replace("?", "").Replace("|", "").Replace("\"", "'").Replace("(", "_").Replace(")", "_").Replace(";", "_");
            hanzi = hanzi.Replace("，", ",").Replace("；", "_").Replace("。", "_").Replace("\"", "").Replace("\"", "").Replace("[", "").Replace("]", "").Replace("【", "").Replace("】", "");
            hanzi = hanzi.Replace("{", "").Replace("}", "").Replace("^", "").Replace("&", "_").Replace("=", "").Replace("~", "_").Replace("@", "_").Replace("￥", "");
            if (hanzi.Length > maxLength)
            {
